 ...
 * 
 * If you transmit a fulfillment, then everyone who has the condition can agree that the condition
 * has been met.
 * 
 * A fulfillment fulfills a Condition.
 * 
 * The fulfillment payload and condition type can be used to regenerate the condition so that it is
 * possible to compare the fingerprint of the condition.
 * 
